        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4 text-sm" style={{ color: "#4a6272" }}>
              <a href={SITE.phone.href} className="flex items-center gap-3 transition-colors hover:text-[#0074a2]">
              ...
              <a href={SITE.whatsapp.href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 transition-colors hover:text-[#25D366]">
              ...
              <a href={`mailto:${SITE.email}`} className="flex items-center gap-3 transition-colors hover:text-[#0074a2]">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg" style={{ backgroundColor: "rgba(0,116,162,0.1)" }}>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" aria-hidden="true">
