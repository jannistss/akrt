export const autoaufbereitungPackages = [
  ...
  { name: "Komplettaufbereitung", price: "139 €", originalPrice: "148 €", savings: "9 €", description: "Innenraum Premium plus Außen Versiegelung – der stärkste Preisvorteil für Innen & Außen komplett.", includes: ["Innenraum Premium komplett", "Außen Versiegelung mit Ceramic-Sprühversiegelung"] },
] as const;
